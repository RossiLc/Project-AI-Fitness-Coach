...
import { MemberRole, type CreateWeComGroupRequest, type CurrentUser, type ImportGroupMembersByUseridRequest } from "@openfit/shared";
...
export class GroupsController {
  ...
  @Post(":id/import-members-by-userid")
  importMembersByUserid(@CurrentUserDecorator() user: CurrentUser, @Param("id") id: string, @Body() body: ImportGroupMembersByUseridRequest) {
    return this.groups.importMembersByUseridRows(user.orgId, id, Array.isArray(body.rows) ? body.rows : []);
  }
}
