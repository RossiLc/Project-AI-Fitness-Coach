...
@Module({
  ...
  providers: [AiConfigService, AiProviderService, AiCheckinParserService, CoachConversationService, CoachProfileMemoryService, CoachService, CoachSafetyService, LocalGuardrailService],
  exports: [AiConfigService, AiProviderService, AiCheckinParserService, CoachConversationService, CoachProfileMemoryService, CoachService]
})
